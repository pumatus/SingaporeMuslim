...
//                    ThirdPartyAnalytics.INSTANCE.logEvent("Calendar", "Swipe", "PreviousMonth", null);
                    ThirdPartyAnalytics.INSTANCE.logEvent(GA.Category.Calendar,
                            GA.Action.Swipe,
                            GA.Label.PreviousMonth);
                } else if (position > lastPostion) {
                    ThirdPartyAnalytics.INSTANCE.logEvent(GA.Category.Calendar,
                            GA.Action.Swipe,
                            GA.Label.NextMonth);
//                    ThirdPartyAnalytics.INSTANCE.logEvent("Calendar", "Swipe", "NextMonth", null);
                }
            }
            ...
            if (monthView != null) {
                ...
                if (mOnCalendarClickListener != null) {
                    mOnCalendarClickListener
                        .onPageChange(monthView.getSelectYear(), monthView.getSelectMonth(),
                            monthView.getSelectDay());
                }
            } else {
    ...
    public void setTodayToView() {
        ...
        if (monthView != null) {
            ...
            monthView.clickThisMonth(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
