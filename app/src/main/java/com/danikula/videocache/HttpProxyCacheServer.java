...
public class HttpProxyCacheServer {
     ...
     */
    public String getProxyUrl(String url) throws IOException {
     ...
     */
    public String getProxyUrl(String url, boolean allowCachedFileUri) throws IOException {
    ...
    private void touchFileSafely(File cacheFile) throws IOException {
    ...
    private void releaseSocket(Socket socket) throws Exception {
